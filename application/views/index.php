...
<div class="row">
	...
	<div class="col-md-4">
		<div class="tile ">
			...
			<a class='btn btn-default'  href="<?php echo base_url() . 'c_incident/addIncident';?>"><i class="fa fa-plus"></i>Submit Alert</a>
			<?php echo $summaries;?>
		</div>
	</div>
</div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-lg" id="map-canvas-lg" style="height:70%;" ></div>

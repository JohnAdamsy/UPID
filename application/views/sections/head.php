...
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/datatables/jquery.dataTables.css"/>
...
<!-- Attach JS files -->
<script src="<?php echo base_url();?>assets/js/jquery-1.8.0.js" type="text/javascript"></script>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/Merged-JS.js"></script>
...
<script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyBfol7f2N0vqpZqVq0TCwdmbYRznKe9sHI&sensor=false"></script>
